...
- 基本ポジティブです。大きな問題にぶつかっても、楽しみながら乗り越えていけます。ただ、楽観的すぎて見積もりが甘くなりがちな点が課題です。
- 自分の力不足を痛感するような厳しい環境に飛び込むのが好きです。パニックゾーンに身を置き続ける。
- ORよりANDで考えたい。トレードオフを乗り越えて両立できないかをまずは考えたいです。
- 常に心から楽しんでますし、楽しんでいたいと思っています。自分だけでなく、チームのみんなが仕事を楽しめている状態を大切にしています。ただ、「楽であること」と「楽しいこと」は別物だと思っています。楽さを求めるのではなく、同じ目標に向かって本気で取り組み、その過程も含めて楽しめる状態が好きです。
