...
15年ほど前、JavaやObjective-CによるiOSアプリ、ActionScriptを使ったWebコンテンツなどを趣味でつくり始めたことが、ソフトウェア開発の原点です。その後、AI/MLの研究開発やBtoB SaaSの開発に携わり、幅広い技術領域を経験してきました。

ハードウェア・ソフトウェアを問わず、新しいものをつくり、それによって人に喜んでもらうことが好きです。

現在は、ソフトウェア技術によってハードウェア産業にグローバルなイノベーションを起こすことに情熱を注ぎ、CTOとして主に次の領域を担っています。
...
プロダクト開発に関わるさまざまな領域を、広く経験してきたジェネラリストタイプです。一つひとつの領域を深く究めているわけではなく、経験には濃淡があります。事業成長を最大化するために「何を、どうつくるか」という抽象度の高い問題に向き合い、広い知見を活かして前に進めていくといったことが得意かもしれません。

単にソフトウェアをつくるのではなく、お客様の業務が根本から変わるような「圧倒的な価値」を届けることを大切にしています。

## Personal

- 趣味：電子機器、キックボクシング、筋トレ、バイク
- エディタ：Vim
- キーボード：sphh jp2
- MBTI：INFJ-A
- 好き：猫、コーヒー
...
- 基本ポジティブです。大きな問題にぶつかっても、楽しみながら乗り越えていけます。なのでどんなときも楽しく笑って過ごしてる人です。ただ、楽観的すぎて見積もりが甘くなりがちな点が課題です。
- 常に心から楽しんでます。自分だけでなく、チームのみんなが仕事を楽しめている状態も大切にしています
  - ただ、「楽であること」と「楽しいこと」は別物だと思っています。楽さを求めるのではなく、同じ目標に向かって本気で取り組み、その過程も含めて楽しめる状態が好きです。
- ORよりANDで考えたい。トレードオフを乗り越えて両立できないかをまずは考えたいです。
- 自分の力不足を痛感するような厳しい環境に身を置き続けて、最大の成長をしたい
